...
import com.wealthfront.screencaptor.sample.impl.R as AppRes
...
class ScreenshotTest {
  ...
  @get:Rule
  var activityTestRule: ActivityScenarioRule<com.wealthfront.screencaptor.sample.impl.SampleActivity> = ActivityScenarioRule(com.wealthfront.screencaptor.sample.impl.SampleActivity::class.java)
  ...
  fun takeScreenshot_recyclerView() {
    ...
    onView(withId(AppRes.id.messageList))
      .check(matches(com.wealthfront.screencaptor.sample.impl.RecyclerViewMatchers.hasItemWithText("Corgi")))
    onView(withId(AppRes.id.messageList))
      .check(matches(com.wealthfront.screencaptor.sample.impl.RecyclerViewMatchers.hasItemWithText("Mastiff")))
  ...
  fun takeScreenshot_modifyImage() {
    val newDrawable = AppCompatResources.getDrawable(getInstrumentation().context, AppRes.drawable.add_accounts)!!
    ScreenCaptor.takeScreenshot(
      activityScenario = activityTestRule.scenario,
